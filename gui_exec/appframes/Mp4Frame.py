...
class Mp4Frame(AppFrame):
    ...
    def run_command_mp4(self):
        ...
        执行导出mp4的命令
        """
        command = 'RplGenCore.exe --Modules export_video --TimeLine {tm} --MediaObjDefine {md} --OutputPath {of} --FramePerSecond {fps} --Width {wd} --Height {he} --Zorder {zd} --Quality {ql} --Language zh '
